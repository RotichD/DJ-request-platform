/*
  ...
  - You are about to drop the column `spotifyId` on the `Request` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "Request" DROP COLUMN "spotifyId",
ADD COLUMN     "tidalId" TEXT;
