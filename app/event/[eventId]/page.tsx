        ...
        <div className="bg-white px-6 py-24 sm:py-32 lg:px-8 dark:bg-gray-900">
            ...
            {isVerified && (
                <><div className='mx-auto max-w-md mt-8'>
                    ...
                    <h2 className='text-4xl font-semibold tracking-tight text-pretty my-4 text-gray-900 dark:text-white'>Queue</h2>
                    <ul role='list' className='divide-y divide-gray-100 dark:divide-white/5'>
                        {queue.map((song) => (
                            <li key={song.id} className='flex justify-between gap-x-6 py5'>
                                <div className='flex min-w-0 gap-x-4'>
                                    ...
                                    <div className='min-w-0 flex-auto'>
                                        <p className="text-sm/6 font-semibold text-gray-900 dark:text-white">{song.title}</p>
                                        <p className="mt-1 truncate text-xs/5 text-gray-500 dark:text-gray-400">{song.artist}</p>
                                    </div>
                                </div>
                                <div className='hidden shrink-0 sm:flex sm:flex-col sm:items-end'>
                                    <p className='text-sm/6 text-gray-900 dark:text-white'>{song.status}</p>
                                </div>
                            </li>
                        ))}
                    </ul>
